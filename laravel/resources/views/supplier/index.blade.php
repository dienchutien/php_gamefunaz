...
<h3 class="col-xs-12 no-padding text-uppercase">Danh sách nhà cung cấp</h3>
        ...
        @foreach ($a_Data as $a_val)
            <tr>
                ...
                <td>                    
                    ...
                    ?>
                    <a title="Edit" href="<?php echo Request::root().'/supplier/addedit?id='.$a_val->id;?>" title="Edit" class="not-underline">
...
<!--Hidden input-->
<input type="hidden" name="tbl" id="tbl" value="supplier">
